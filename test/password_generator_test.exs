defmodule PasswordGeneratorTest do
  ...
  test "returns a string uppercase", %{options_type: options} do
  ...
  test "returns string just with uppercase and numbers", %{options_type: options} do
  ...
  test "returns string with all included", %{options_type: options} do
    options_all_included = %{
      "length" => "10",
      "numbers" => "true",
      "uppercase" => "true",
      "symbols" => "true"
    ...
    {:ok, result} = PasswordGenerator.generate(options_all_included)
